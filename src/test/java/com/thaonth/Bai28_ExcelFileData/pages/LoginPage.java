...
public class LoginPage extends CommonPage {
    ...
    private By menuLogout = By.xpath("//a[text()='Logout']");
    private By buttonLogout = By.xpath("//div[@id='system-popup']//div[@class='popup-content']/a");
